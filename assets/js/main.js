...
var ajustControlSize = exports.ajustControlSize = function ajustControlSize() {
  ...
  document.querySelector('#selected-container').style.height = mapHeight + 'px';
  document.querySelector('#suggestions-container').style.height = mapHeight + 'px';
};
...
var calculateAndDisplayRoute = exports.calculateAndDisplayRoute = function calculateAndDisplayRoute(map, destination) {
  ...
  window.updateRouteTimer = navigator.geolocation.watchPosition(function (pos) {
