...
var mapControl = exports.mapControl = function mapControl() {
  var processData = function processData(data) {
    ...
    var showSelected = function showSelected() {
      ...
      if (window.isDisplayRoute) {
        window.isDisplayRoute = false;
        clearTimeout(window.updateRouteTimer);
        console.log('cleared');
      }
    };
    ...
    navigator.geolocation.getCurrentPosition(function (pos) {
      directionsService.route({
        ...
        if (status === 'OK') {
          ...
          if (window.isDisplayRoute) {
            window.updateRouteTimer = setTimeout(updateRoute, 5000);
          }
        } else {
